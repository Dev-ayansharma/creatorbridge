    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
         A simple 3-step workflow for seamless collaboration between editors and YouTubers.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          style={{ height }}
          className="absolute left-8 top-0 w-[2px] bg-gradient-to-b from-transparent via-neutral-200 to-transparent"
        >
          <motion.div
            style={{
