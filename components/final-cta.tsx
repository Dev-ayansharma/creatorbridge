  ...
  return (
    <section className="py-24 px-4">
      ...
      >
        ...
        >
         Start collaborating without sharing channel access.
        </h2>
        <p className="text-lg sm:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto">
         Upload, review, and publish videos seamlessly. Give your editors the freedom to work — 
while you stay in full control of your YouTube channel.
        </p>
        ...
        <p className="mt-8 text-sm text-zinc-500">No channel access sharing. Secure. Simple. Built for creators.</p>
      </motion.div>
    </section>
  )
}
