...
const plans = [
  {
    ...
    features: ["workspace", "limited uploads", "Basic analytics", ],
    cta: "Get Started",
    highlighted: true,
  },
  {
    name: "Pro(Not available)",
    description: "For growing more that need more power",
